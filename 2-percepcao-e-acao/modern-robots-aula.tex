...
\begin{frame}{Modern Robots}
    ...
    \end{block}
    \href{https://www.youtube.com/watch?v=fn3KWM1kuAw}{\faIcon{youtube}}
\end{frame}
...
\begin{frame}{Modern Robots}
    ...
    \href {https://www.youtube.com/watch?v=24jufNhuUSI}{\faIcon{youtube}}
    \href {https://www.youtube.com/watch?v=GD63_aF9d_c}{\faIcon{youtube}}
\end{frame}
...
\begin{frame}[fragile]{Modern Robots}
    ...
    \end{minipage}
    \begin{minipage}{0.7\textwidth}
            \textcolor{purple}{\textbf{Simulation}}:
            \begin{itemize}
...
\begin{frame}[fragile]{Modern Robots}
    ...
    \begin{minipage}{0.7\textwidth}
            ...
            \end{itemize}
            \begin{figure}
                \cpright{\includegraphics[width=1\textwidth]{./images/ANYmal_ROS_real.png}}
                {https://www.anybotics.com/anymal-legged-robot/}
            \end{figure}
    \end{minipage}

    \href{https://www.youtube.com/watch?v=lKYh6uuCwRY}{\small(\faIcon{youtube} Learning to walk)}
    \href{https://www.youtube.com/watch?v=807_cByUBSI}{\small(\faIcon{youtube} TB3 Avoiding Obstacles)}
\end{frame}
