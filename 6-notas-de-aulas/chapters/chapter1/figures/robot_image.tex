...
\begin{tikzpicture}
    ...
    \link(#1:#2);
    \joint
    \node[left]{$\color{red}{\theta_1}$};
    \begin{scope}[shift=(#1:#2), rotate=#1]
        \link(#3:#4);
        \joint
        \node[above]{$\color{red}{\theta_2}$};
        \begin{scope}[shift=(#3:#4), rotate=#5]
            \grip
            \node[right]{$\color{blue}{\mathbf{x}_{f}}$};
        \end{scope}
    \end{scope}
    }
    ...
    \node at (8,2) {$\color{red}{
        ...
        \end{bmatrix}
      }, \quad \text{Espaço das juntas}$};
    \node at (8,0) {$\color{blue}{
        \mathbf{x} =
        \begin{bmatrix}
            x_1 \\x_2 \\ \cdots \\ x_n
        \end{bmatrix}
      }, \quad \text{Espaço das tarefas}$};
\end{tikzpicture}
