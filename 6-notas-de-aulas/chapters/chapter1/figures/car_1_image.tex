...
\begin{tikzpicture}[
    ...
    wheel/.style={fill=black, rounded corners=1.5pt},
     ...
     \begin{scope}[rotate=0]
        ...
        {[axis,->]
            ...
            \draw (M) -- ++(2,0) node[yshift=-5] {$x'$};
        }
        % Forces
        {[force,->]
            % Assuming that Mg = 1. The normal force will therefore be cos(alpha)
            \draw (M.east) -- ++(1,0) node[above, blue] {$\mathbf{p}_{t-1}$};
        }
    ...
    \begin{scope}[rotate=\iangle]
        ...
        {[force,->]
            % Assuming that Mg = 1. The normal force will therefore be cos(alpha)
            \draw (M.east) -- ++(1,0) node[above, blue] {$\mathbf{p}_t$};
        }
    ...
    \draw[gray, dotted, ->] (-2,-1) -- ++(-.5,-.5) node[left] {$z$};
