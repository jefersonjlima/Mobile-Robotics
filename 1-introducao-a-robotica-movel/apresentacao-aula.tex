...
\begin{frame}[t]{Ementa da Disciplina}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{figure}[h]
				\cpright{\includegraphics[width=0.6\textwidth]{./images/livro9}}
				{\cite{romero2014robotica}}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}[h]
				\cpright{\includegraphics[width=0.7\textwidth]{./images/livro2}}
...
\begin{frame}[c]{Ementa da Disciplina}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\cpright{\includegraphics[width=0.6\textwidth]{./images/livro3}}
				{\cite{lynch2017modern}}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\cpright{\includegraphics[width=0.6\textwidth]{./images/livro4}}
...
\begin{frame}[t]{Ementa da Disciplina}
	...
	\begin{itemize}
		\item  Robot Operating System (ROS)
		      \begin{center}
			      \cpright{\includegraphics[width=0.7\textwidth]{./images/ros_msgs.png}}
				  {\cite{joseph2017ros}}
		      \end{center}
	\end{itemize}
\end{frame}
...
\begin{frame}[t]{Ementa da Disciplina}
	...
	\begin{itemize}
		\item  Robot Operating System (ROS)
		      \begin{center}
				\cpright{\includegraphics[width=0.7\textwidth]{./images/ros_example.png}}
				{\cite{joseph2017ros}}
		      \end{center}
	\end{itemize}
\end{frame}
...
\begin{frame}[t]{Ementa da Disciplina}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\cpright{\includegraphics[width=0.7\textwidth]{./images/livro7}}
				{\cite{joseph2017ros}}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\cpright{\includegraphics[width=0.7\textwidth]{./images/livro8}}
...
\begin{frame}[c]{Ementa da Disciplina}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\cpright{\includegraphics[width=0.7\textwidth]{./images/livro1}}
