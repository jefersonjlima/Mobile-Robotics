...
\begin{frame}[fragile]{ROS Topics}
	...
	\lstinputlisting[language=c++, linerange={1-2}]{../examples/Chapter03/ros_examples/src/clock_node.cpp}
	Next that you need to create the \textit{clock\_sys} variable.
	\lstinputlisting[language=c++, linerange={4-6}]{../examples/Chapter03/ros_examples/src/clock_node.cpp}
	Now the node configuration:
	\lstinputlisting[language=c++, linerange={8-14}]{../examples/Chapter03/ros_examples/src/clock_node.cpp}
