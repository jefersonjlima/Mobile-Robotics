...
%% TODO https://gitlab.com/cursoseaulas/robotica-movel/-/issues/4
% \begin{frame}[fragile]{ROS Topics}
% 	\framesubtitle{\textcolor{blue}{CLOCK\_NODE} Example}

% 	Make sure you include the header file  \textit{rosgraph\_msgs\/Clock.h}.

% 	\lstinputlisting[language=c++, linerange={1-2}]{"\RMHOME/examples/Chapter03/ros_examples/src/clock_node.cpp"}

% 	Next that you need to create the \textit{clock\_sys} variable.

% 	\lstinputlisting[language=c++, linerange={4-6}]{"\RMHOME/examples/Chapter03/ros_examples/src/clock_node.cpp"}

% 	Now the node configuration:
	
% 	\lstinputlisting[language=c++, linerange={8-14}]{"\RMHOME/examples/Chapter03/ros_examples/src/clock_node.cpp"}
